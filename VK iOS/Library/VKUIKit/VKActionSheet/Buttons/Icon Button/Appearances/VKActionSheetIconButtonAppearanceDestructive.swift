//
//  VKActionSheetIconButtonAppearanceDestructive.swift
//  VK iOS
//
...
class VKActionSheetIconButtonAppearanceDestructive: VKActionSheetIconButtonAppearance {
    var iconTintColor: UIColor? = VKPalette.red
    var highlightedIconTintColor: UIColor? = VKPalette.red
